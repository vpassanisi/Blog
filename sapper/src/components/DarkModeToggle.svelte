...
<style>
  ...
  input:checked + .container__toggle .toggle__moves {
    transform: translateX(28px);
  }

  input:checked + .container__toggle .toggle__moon {
    opacity: 0;
  }

  input:checked + .container__toggle .toggle__sun {
    opacity: 1;
  }
</style>
